...
class DashboardPostController extends Controller
{
    ...
    {
        $post = $this->hitungJumlahPost();
        return view('dashboard.settings.main', [
            'hitung' => $post
        ]);
    }
    /**
    ...
    public function hitungJumlahPost()
    {
    ...
    {
        $crot = User::where('id', auth()->user()->id)->first();
        return view('dashboard.biolink.main', [
            'crot2' => $crot
        ]);
    }
    ...
    public function updateprofil(Request $request)
    {
        ...
        $ueueu = User::where('id', auth()->user()->id)->first();
    ...
    // public function ubahJSON(){
    //     $dataJSON = User::all();
    //     $hasilJSON = json_encode($dataJSON);
    //     return $hasilJSON;
    // }
