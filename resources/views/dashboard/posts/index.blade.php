        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <a title="View" class="badge bg-info" href="/dashboard/posts/{{ $post->slug }}"><i class="bi bi-view-stacked"></i></a>
                <a title="Edit" class="badge bg-warning" href="/dashboard/posts/{{ $post->slug }}/edit"><i class="bi bi-pencil-square"></i></a>
